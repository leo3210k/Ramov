...
function Hero() {
  return (
    <div className="relative h-[85vh] lg:h-screen flex items-center lg:bg-hero bg-right bg-contain bg-no-repeat p-6 lg:p-0">
      <div className="h-full lg:w-2/6 flex flex-col justify-between lg:justify-normal text-left gap-6 lg:ml-36">
